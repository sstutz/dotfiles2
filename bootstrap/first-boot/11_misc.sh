...
,optional_keyboard_settings() {
    ...
    localectl set-x11-keymap us,de pc104 nodeadkeys compose:caps
}
...
,optional_install_additional_software() {
    pacman -S ttf-liberation noto-fonts noto-fonts-emoji ttf-hack ttf-fira-mono \
...
local grml_version="2024.02"
local iso="grml64-small_${grml_version}.iso"
...
options lang=us utc tz="$DF_TIMEZONE" boot=live live-media-path=/grml/
EOT
popd || return
}
