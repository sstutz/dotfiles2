...
#
# note: when creating a btrfs filesystem the main ( / ) subvolume will have the subvolid=5
# subsequent subv create commands will be children of / and start with the subvolid 256 and increae by one
...
btrfs subvolume create "$DF_MOUNT/@/usr"
